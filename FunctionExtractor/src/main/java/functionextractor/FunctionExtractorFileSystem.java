...
@FileSystemInfo(type = "fstypegoeshere", // ([a-z0-9]+ only)
		description = "File system description goes here", factory = FunctionExtractorFileSystem.MyFileSystemFactory.class)
public class FunctionExtractorFileSystem implements GFileSystem {
	 ...
	 */
	public FunctionExtractorFileSystem(FSRLRoot fsFSRL, ByteProvider provider) {
		this.fsFSRL = fsFSRL;
	...
	public void mount(TaskMonitor monitor) {
		monitor.setMessage("Opening " + FunctionExtractorFileSystem.class.getSimpleName() + "...");
	...
	public static class MyFileSystemFactory
			implements GFileSystemFactoryFull<FunctionExtractorFileSystem>, GFileSystemProbeFull {

		@Override
		public FunctionExtractorFileSystem create(FSRL containerFSRL, FSRLRoot targetFSRL,
				ByteProvider byteProvider, File containerFile, FileSystemService fsService,
				TaskMonitor monitor) throws IOException, CancelledException {

			FunctionExtractorFileSystem fs = new FunctionExtractorFileSystem(targetFSRL, byteProvider);
			fs.mount(monitor);
			return fs;
		}
